...
*/            
            ...
            censusSummary += `<p><img src="lib/i/place.png"" alt="Date"> ${ expandChapmanCodes( event.place.split('http')[0].trim() ) }</p>`
            
            if (event.head && event.wife) censusSummary += `<p><img src="lib/i/parents.png" alt="Head & wife"> `
